...
ft_cd.c ft_exe.c ft_input.c ft_redirections.c ft_pipe.c ft_pipe2.c ft_wait.c ft_error.c ft_ctrl.c ft_free.c get_next_line.c get_next_line_utils.c minishell.c
